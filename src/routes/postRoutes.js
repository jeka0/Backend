...
const {createPost, getPost, getAllPosts, getCurrentUserPosts, getUserPosts, updatePost, deletePost, getRange, getUserRange, addUserLike} = require('../controllers/postController');
